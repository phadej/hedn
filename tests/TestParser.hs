...
main :: IO ()
main = do
    forM_ cases       $ checkCase (parse P.parseValue)  (parserResult)
    forM_ casesTagged $ checkCase (parse P.parseTagged) (parserResult)
...
casesTagged :: [(BSL.ByteString, E.TaggedValue)]
